/**
 * This is the game method for Logic1 with SRGS_SPS agent.
 * @author 170024030
 *
 */
public class Logic1_1 {
	/**
	 * The main method
	...
	public static void main(String[] args) {
		...
		try {
			...
			Agent_SRGS_SPS agent = new Agent_SRGS_SPS(map);
			...
			while(!agent.unknown.isEmpty()) {
				//if SPS doesn's work resort to SRGS
				if (!agent.sps()) {
					agent.srgs();
				}
				if (!agent.isSafe) {
